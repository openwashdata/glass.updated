...
For a complete description of all 121 variables, see
...
The package code is licensed under [CC BY
4.0](https://openwashdata.github.io/glass.updated/LICENSE.md). The GLAAS
